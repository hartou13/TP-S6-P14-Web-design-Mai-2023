...
<head>
    ...
    <title>login</title>
    <link rel="stylesheet" href={{ secure_url('/styles/bootstrap/css/bootstrap.min.css') }}>
    <link rel="stylesheet" href={{ secure_url('/styles/fonts/fontawesome-all.min.css') }}>
    <link rel="stylesheet" href={{ secure_url('/styles/css/styles.min.css') }}>
</head>
    ...
    <section class="login-dark">
        <form action="/login" method="post">
            ...
            <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"
                    value="adm1@gmail.com"></div>
            <div class="mb-3"><input class="form-control" type="password" name="mdp" placeholder="Password"
                    value="adm1"></div>
